    ...
    <div className="settings-layout settings-layout--product">
      <Card className="settings-card liquid-panel" variant="borderless">
        ...
        <Paragraph className="muted">
          These settings change how the planner works: daily capacity, focus
          blocks, automation and the density of the board.
        </Paragraph>
        ...
        >
          <div className="settings-grid-two">
            <NumberSetting
              ...
              helper="Used for workload forecast and overload warnings."
            ...
            <NumberSetting
              ...
              helper="Used by the smart focus queue."
            ...
            <NumberSetting
              label="Card spacing"
              helper="Controls board density without breaking the layout."
              name="cardPadding"
              min={12}
              max={28}
              suffix="px"
            ...
            <NumberSetting
              label="Title size"
              helper="Keeps task cards readable on large screens."
              name="headerFontSize"
              min={15}
              max={24}
              suffix="px"
          ...
          <div className="settings-switch-grid product-switches">
            <Form.Item
              label="Show Today’s Focus"
              name="showFocusPanel"
              valuePropName="checked"
              extra="Turns the smart queue in the hero on or off."
            >
              <Switch />
            </Form.Item>
            <Form.Item
              ...
              name="compactMode"
              valuePropName="checked"
              extra="Shows more cards when the backlog is large."
            >
              <Switch />
            </Form.Item>
            <Form.Item
              label="Auto-archive completed"
              name="autoArchiveCompleted"
              valuePropName="checked"
              extra="Keeps the active board clean for real work."
            >
              <Switch />
            </Form.Item>
            <Form.Item
              label="Reduce background motion"
              name="reduceMotion"
              valuePropName="checked"
              extra="Useful for long work sessions and accessibility."
            >
              <Switch />
            </Form.Item>
          </div>
      ...
      <Card
        className="settings-card liquid-panel settings-value-card"
        variant="borderless"
      >
        ...
        <div className="value-list">
          <div>
            ...
            <span>Prevents overloading the day with more work than fits.</span>
          </div>
          <div>
            <b>Focus queue</b>
            <span>Turns a messy backlog into the next few actions.</span>
          </div>
          <div>
            <b>Automation</b>
            <span>
              Keeps completed work out of the way without deleting history.
            </span>
          </div>
          <div>
            <b>Accessibility</b>
            <span>Motion and density can be adjusted for long sessions.</span>
          </div>
        </div>
      </Card>
    </div>
